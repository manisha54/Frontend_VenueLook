...
import '../test/unit_test/user_unit_test.mocks.dart';
...
void main() {
  ...
  testWidgets('login test with username and password and open dashboard Page',
      (WidgetTester tester) async {
    when(mockUserUsecase.loginUser('manisha', 'manisha123'))
    ...
    await tester.enterText(find.byType(TextField).at(0), 'manisha');
